...
namespace LumeWeb\Portal\Generated\Admin;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (LumeWeb\Portal\Generated\Admin) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: unknown' . PHP_EOL;
