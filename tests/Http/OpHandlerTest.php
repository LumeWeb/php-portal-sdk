 ...
 *
 * These mirror the behavior of the Go SDK's internal/http.OpHandler:
 * success codes pass through, operation -> status error factories map to
 * typed PHP exceptions, HTTP sentinels fall back to typed exceptions, and
 * anything else becomes a generic PortalException carrying the operation
 * name, status code and response body.
 */
